# 🏟️ FlowSync AI — Predictive Stadium Management System
...
| 🗳️ **Crowd Voting** | Attendees can report congestion levels; confidence-tiered votes enhance AI recommendations |
| 🌍 **Multi-Language AI** | AI responds in English, Tamil, Hindi, Spanish, Mandarin, or French |
...
```bash
# 1. Clone the repo
git clone https://github.com/your-username/FlowSync_AI.git
cd FlowSync_AI
...
> ⚠️ **Security Note**: For production deployments, proxy Gemini API calls through a backend serverless function (e.g. Vercel Edge Functions) to avoid exposing the API key in the client bundle.
